\documentclass[AMA,STIX1COL]{WileyNJD-SP}

\articletype{WORLD BANK RUSSIA EDUCATION: Working Paper}%
...
\title{Returns to Education in the Russian Federation:1995-2018}

\author[1,2]{Ekaterina Melianova}

\author[1]{Suhas D. Parandekar*}

\author[1]{Harry A. Patrinos}

\author[1,2]{Art\"{e}m Volgin}

\authormark{World Bank Education Global Practice}


\address[1]{\orgdiv{The World Bank}}

\address[2]{\orgdiv{National Research University-Higher School of Economics}}

%\address[3]{\orgdiv{Org Division}, \orgname{Org Name}, \orgaddress{\state{State %name}, \country{Country name}}}

\corres{*Corresponding author name, This is sample corresponding address. \email{authorone@gmail.com}}

\acknowledgments{This work is carried out under the leadership of Harry Patrinos, the World Bank's Practice Manager for Education in the Eastern Europe and Caribbean Region. The authors acknowledge with thanks the Russian Ministry of Finance, the Russian Ministry of Education and the Higher School of Economics for use of the data made available for the study.}
