...
\title{Education Equity Blix Blax Paper 1}

% List abbreviations here, if any. Please note that it is preferred that abbreviations be defined at the first instance they appear in the text, rather than creating an abbreviations list.
\acks{ABC, a black cat; DEF, doesn't ever fret; GHI, goes home immediately.}
...
%\presentadd[\authfn{2}]{Department, Institution, City, State or Province, 
%Postal Code, Country}
