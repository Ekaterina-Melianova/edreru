...
\fundinginfo{Thanks are due to the Ministry of Education for the 
graduate.ru website that provides data on graduates earnings available to 
the public. Thanks are due to the Ministry of Finance for the bus.gov.ru 
website that provides the data on revenues received by all public 
institutions including colleges and universities. The code used for this 
paper is made freely available for all researchers at 
\url{https://bitbucket.org/zagamog/edreru/src/master/}}
...
\runningauthor{P170978: WP04 - Private and Fiscal Returns to Education}
...
\vspace{.5em}
\noindent This paper uses institution 
...
\fontsize{9}{11}{
	...
	\begin{longtable}{lcccccc}
		\caption{Mincerian, Private and Fiscal Returns by Region}
		\label{tab:4.1}\\
&   \multicolumn{2}{c}{\textbf{Mincerian }} & \multicolumn{2}{c}{\textbf{Private}} & \multicolumn{2}{c}{\textbf{Fiscal}} \\ 
	    \hline
