...
\begin{table}[htbp!]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lcccccccccc}
			...
			&  & \multicolumn{2}{c}{Wage} & \multicolumn{2}{c}{Experience} & \multicolumn{2}{c}{Education years} & \phantom{000} Secondary & \phantom{000} Vocational & \multicolumn{1}{c}{\phantom{00}Higher} \\ 
			Year  & N & Mean & SD &  \phantom{000} Mean & \phantom{0000}SD & \phantom{000} Mean & \phantom{0000} SD & 
		\phantom{000}	Percent & \phantom{000} Percent & \multicolumn{1}{c}{\phantom{00} Percent} \\ 
			\hline
...
\begin{table}[h!]\centering
	...
	\begin{tabular}{l*{2}{c}}
		...
		Paganâ€“Hall for heteroskedasticity  &  5.780   & 9.973 \\
