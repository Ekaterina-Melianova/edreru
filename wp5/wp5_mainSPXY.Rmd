...
col_HE <- ifelse(df_region_returns_university_full$Dep_reg==1, "red", "black")



# Plot the salaries by the areas
ggplot(df_region_returns_university_full, aes(x=reorder(en_rgnames, psgapu,group=returns_type), y=returns)) +
  geom_point(aes(color=returns_type),size=3) +
  geom_line(aes(color=as.factor(Dep_reg)))+
  ...
  theme(plot.title = element_blank(),
        ...
        legend.title=element_text(size=14),legend.position=c(0.80,0.40)) +
    labs(y = "Internal rate of return") + 
   scale_color_manual(values=c("deepskyblue1", "red","blue",
                               "black"), 
                    name="",labels=c("Other regions","Priority  regions", "Private returns", "Social returns"))
...
# Plot the salaries by the areas
ggplot(df_region_returns_college_full, aes(x=reorder(en_rgnames, psgapc,group=returns_type), y=returns)) +
  geom_point(aes(color=returns_type),size=3) +
  geom_line(aes(color=as.factor(Dep_reg)))+
  coord_flip() + theme_light() + 
  theme(plot.title = element_blank(),
        ...
        legend.text = element_text(size=14),                      
        legend.title=element_text(size=14),legend.position=c(0.80,0.20)) +
    labs(y = "Internal rate of return") + 
   scale_color_manual(values=c("deepskyblue1", "red","blue",
                               "black"), 
                    name="",labels=c("Other regions","Priority  regions", "Private returns", "Social Returns"))
...
df_universities_moscow <- df_universities %>% filter(region_name == "Moscow")
...
ggmap(map_mo) +
  ...
  ggtitle("Fiscal IRR (3 years) Universities in Moscow") + 
...
df_colleges_spb <- df_colleges %>% filter(region_name == "Saint-Petersburg")
...
ggmap(map_spb) +
  ...
  scale_color_manual(values = c("coral2", "cornflowerblue", "green3")) +
  ggtitle("Fiscal IRR (3 years) Colleges in Saint Petersburg") + 
  theme(plot.title = element_text(size=18, face="bold"),
...
plot1 <- ggplot(df_universities, aes(reorder(specialization_type, social_returns), social_returns)) +
  geom_boxplot(outlier.shape = NA, fill="deepskyblue2") + 
  coord_flip() +
  ggtitle("Social IRR (3 years) by Specialization of University") + 
  labs(y="Average Social IRR", x = "Specialization of university") + 
  theme_light(base_size = 18) + theme(
    plot.title = element_text(size=18, face="bold"), axis.text = element_text(size=22))
  # scale_y_continuous(limits=c(20000, 80000))
...
plot2 <- ggplot(df_colleges, aes(reorder(speciality_type, social_returns), social_returns)) +
  geom_boxplot(outlier.shape = NA, fill="lightcoral") + 
   coord_flip() +
  ggtitle("Social IRR (3 years) by Specialization of College") +
