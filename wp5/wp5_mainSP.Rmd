...
df_region_returns_university_full <-
  left_join(df_region_returns_university_full,
             reg_wp3,
             by=c("region"="OKATO"))

df_region_returns_college_full <-
  left_join(df_region_returns_college_full,
             reg_wp3,
             by=c("region"="OKATO"))
...
# Plot the salaries by the areas
ggplot(df_region_returns_university_full, aes(x=reorder(en_rgnames, returns), y=returns, color=returns_type)) +
  geom_point(size=3) +
