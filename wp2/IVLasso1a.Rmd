...
# Generating age
rlms18$age <- 2018 - as.numeric(as.character(rlms18$birth_))
#summary(rlms18$age)

# Birth decades

#paste(paste0("rlms18$birth_19", 53:59), '==1', collapse = '|') # manually pasting this expression to ifelse()
rlms18$birth_50 <- ifelse(rlms18$birth_1953 ==1|rlms18$birth_1954 ==1|rlms18$birth_1955 ==1|
...
**Estimating 2SLS based on what Lasso selected (shows quite different estimates)**
