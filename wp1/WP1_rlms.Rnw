...
<<Data preprocessing, echo=F, cache=F, include=F, results=hide>>=
...
<<Contd, echo=F, cache=F, include=F, results=hide>>=
...
setwd("C:/Country/Russia/Data/SEABYTE/RLMS/edreru/wp1")
...
<<Tagging, echo=F, cache=F, results=hide>>=
# The resulting table
...
\begin{table}[H]
        ...
        \label{tab:1}
<<Table with cohorts, echo=F, results = tex>>=
...
<<Regression results, echo=F, cache=FALSE, results=hide>>=
...
RoREs_1$variable <- factor(RoREs_1$variable,
...
RoREs_2a$variable <- factor(RoREs_2a$variable,
                           labels = c("Higher education",
                                      "Vocational education"))
...
RoREs_2b$variable <- factor(RoREs_2b$variable,
                           labels = c("Higher education",
                                      "Vocational education"))
# Plotting males
...
RoREs_3a$variable <- factor(RoREs_3a$variable,
                           labels = c("Higher education",
                                      "Vocational education"))
...
RoREs_3b$variable <- factor(RoREs_3b$variable,
                           labels = c("Higher education",
                                      "Vocational education"))
...
<<Regression tables, echo=F, cache=FALSE, results=tex>>=
